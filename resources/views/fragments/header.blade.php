        ...
        <div class="collapse navbar-collapse" id="navbarToggler">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item nav-item-select {{ Request::is('adopt*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ url('adopt?filters-sort=0&filters-type=0') }}">Adopt a Pet {!! Request::is('adopt*') ? '<span class="sr-only">(current)</span>' : '' !!}</a>
                </li>
                ...
                @elseif (Auth::check())
                    <li class="nav-item nav-item-select {{ Request::is('profile/applications/*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ url('profile/applications/view/') }}">My Applications {!! Request::is('pending*') ? '<span class="sr-only">(current)</span>' : '' !!}</a>
                    </li>
                @endif
            </ul>
